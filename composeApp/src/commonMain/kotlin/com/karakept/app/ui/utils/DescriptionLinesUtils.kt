...
/**
 * How many description lines fit in the space the rest of the row leaves over.
 *
 * The row is as tall as its thumbnail — or as tall as the tile a paged list holds it to — so
 * whatever the title, url and metadata do not use is dead space, usually 20-30dp of it and much
 * more when the title sits above the thumbnail. This turns that leftover into description lines
 ...
 *
 * @param availableHeightPx the height the row will take regardless: its thumbnail, or the fixed
 *   height a tiled list has imposed on it.
...
fun computeAutoDescriptionLines(
    ...
    val available = availableHeightPx - consumedHeightPx
