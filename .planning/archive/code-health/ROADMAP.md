# Roadmap: Karakept KMP — Code Health (code-health)
...
Plans:
- [ ] 01-01-PLAN.md — Create AppLogger, extend SnackbarEvent with retry, replace all printStackTrace and debug println
- [ ] 01-02-PLAN.md — Wire error propagation to snackbar and eliminate all !! operators
...
**Goal**: Close all non-critical integration gaps from the code-health milestone audit and reduce accumulated tech debt
...
**Gap Closure:** Closes gaps from code-health-MILESTONE-AUDIT.md
**Success Criteria** (what must be TRUE):
