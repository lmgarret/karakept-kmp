...
| 07. UI Tests | v1.8.0 | 0/2 | Planned | -- |
...
Plans:
- [ ] 07-01-PLAN.md -- Build infrastructure + ScreenModel tests (FILT-01, FILT-02, FILT-03, regression)
- [ ] 07-02-PLAN.md -- Compose UI tests (READER-03/04) + Activity lifecycle tests (SAVE-01/02)
